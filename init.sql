...
ALTER TABLE IF EXISTS public.produtos OWNER to postgres;
...
ALTER TABLE IF EXISTS public.produto_caracteristicas OWNER to postgres;
...
ALTER TABLE IF EXISTS public.produto_imagens OWNER to postgres;
